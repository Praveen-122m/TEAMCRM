...
const runTest = async () => {
  try {
    ...
    // 4. Test getHistoryCampaigns
    console.log('\n=== TESTING GET /api/meta/history/campaigns (with followers) ===');
    ...
    if (campaignsData.length > 0) {
      console.log('First Campaign Row sample (with instagram_followers):', campaignsData[0]);
      if (campaignsData[0].instagram_followers === undefined) {
        throw new Error('instagram_followers field missing in campaign history rows');
      }
    }
