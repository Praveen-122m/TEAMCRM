  ...
  return (
    <div className="glass-panel p-6 border border-crm-border">
      <div className="flex items-center gap-3 mb-4">
        ...
        <div>
          <h3 className="font-bold text-crm-text">Join a Workspace</h3>
      ...
      <form onSubmit={handleJoin} className="flex flex-col sm:flex-row gap-3">
        <div className="relative flex-1">
          ...
          <input
            ...
            className="w-full bg-crm-dark border border-crm-border rounded-xl pl-10 pr-4 py-3 text-sm text-crm-text font-mono tracking-widest uppercase focus:border-crm-primary focus:outline-none"
            required
          />
        </div>
        <button
