...
export const metaService = {
  getAuthUrl: (clientId, workspaceId) => `${import.meta.env.VITE_API_URL || '/api'}/meta-ads/connect?clientId=${clientId}&workspaceId=${workspaceId}`,
  ...
  savePageId: (clientId, pageId) => api.post('/meta-ads/page-id', { clientId, pageId }),
  getMetaStatus: (clientId) => api.get('/meta-ads/status', { params: { clientId } }),
};
