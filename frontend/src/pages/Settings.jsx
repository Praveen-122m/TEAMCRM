...
const Settings = () => {
  ...
  return (
    <div className="max-w-4xl mx-auto space-y-8">
      <div>
        <h1 className="text-2xl font-bold text-crm-text tracking-tight">Settings</h1>
        <p className="text-crm-textMuted text-sm mt-1">Manage your account settings and preferences.</p>
      </div>

      <div className="glass-panel p-8">
        <h3 className="text-lg font-bold text-crm-text mb-6 border-b border-crm-border pb-4">Profile Information</h3>
