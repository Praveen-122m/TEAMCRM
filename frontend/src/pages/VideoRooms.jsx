...
const VideoRooms = () => {
  ...
  const fetchRooms = async () => {
    const rawId = activeWorkspace || user?.workspaces?.[0] || sessionStorage.getItem('activeWorkspace');
          ...
          <DialogContent sx={{ overflow: 'visible' }}>
            {modalMode === 'join' ? (
              ...
              <Stack spacing={3}>
                ...
                {modalMode === 'schedule' && (
                  <Box>
                    <Typography variant="caption" sx={{ color: 'text.secondary', ml: 1, mb: 0.5, display: 'block' }}>Schedule For</Typography>
                    <DatePicker
